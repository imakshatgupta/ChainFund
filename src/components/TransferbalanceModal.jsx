...
export default function TransferModal() {
  ...
  const handleSubmit = (event) => {
    ...
    makeCryptoPayment(receiver, balance);
    setBalance("");
    setReceiver("");
    handleClose();
  };
          ...
          <ModalContent sx={style}>
            ...
            <form onSubmit={handleSubmit}>
              <input
                ...
                className="p-2 mt-4 w-full rounded-[10px] outline-none"
                value={balance}
              ...
              <button
                type="submit"
                className="p-2 mt-4 w-full rounded-[10px] bg-blue-gradient text-white"
              >
                Transfer
              </button>
            </form>
