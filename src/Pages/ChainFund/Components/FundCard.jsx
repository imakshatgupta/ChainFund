...
const FundCard = ({ handleClick }) => {
  const owner = "John Doe";
  const title = "Education Fundraiser";
  const description = "Helping students access quality education";
  const target = "$5000";
  const deadline = new Date("2024-03-15");
  const amountCollected = "$3500";
  const image = "https://images.pexels.com/photos/19845798/pexels-photo-19845798/free-photo-of-cube-of-ice-beside-ocean.jpeg?auto=compress&cs=tinysrgb&w=1200&lazy=load";
